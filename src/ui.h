...
typedef struct {
    ...
    int toolbar_expanded;

    int timeline_scroll;
    int timeline_visible_frames;
    int timeline_dragging;
...
int ui_button(int x, int y, int w, int h, const char *label,
              unsigned int color, InputState *input);
int ui_icon_button(int x, int y, int size, const char *icon_char,
                   unsigned int color, InputState *input);
